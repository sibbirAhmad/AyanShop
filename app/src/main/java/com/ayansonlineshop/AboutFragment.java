...
import static soft.insafservice.apphelper.MyFunc.initSP;
...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        TextView appVersionTV = rootView.findViewById(R.id.appVersionTV);
        appVersionTV.setText("App Version : "+BuildConfig.VERSION_NAME);
...
//        //Animating Text
//        typeWriter.animateText(MyFunc.getSP(SpKey.APP_URL,""));
